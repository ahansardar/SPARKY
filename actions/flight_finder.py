...
# SPARKY — Flight Finder
#
# Searches for flights using Google Flights via browser_control.
# Results are spoken by SPARKY. Optionally saved to Notepad or opened in browser.
#
# Flow:
...
def _parse_flights_with_gemini(
    ...
    """
    Sends raw page text to LLM and extracts structured flight data.
